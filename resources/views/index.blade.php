...
<header id="header" class="masthead">
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-md-4" ><div class="d-none d-sm-block"><p class="left_text"> نؤمن بقيمة منتجك وانك تستحق افضل مستوي خدمة</p></div></div>
            <div class="col-md-4 text-center"> <p class="main_text">شركاؤك نحو النجاح</p></div>
            <div class="col-md-4 text-right"><div class="d-none d-sm-block"><p class="right_text">نحن نبني حلولاً برمجية تقدم تجارب مستخدم مخصصة تضمن قيمة أعلى مدى الحياة.</p></div></div>
        </div>
...
<div class="container h-100" style="padding-top: 90px; ">
    <div class="services_image">
        <img src="{{ asset('images/home/vector-services.svg') }}">
    </div>
    ...
    <div class="row align-items-center" style="margin-top: 70px; height: auto;">
        <div class="col-md-4 col-sm-offset-0"></div>
        <div class="col-md-2 col-sm-6">
            <img src="{{ asset('images/icons/markting.svg') }}" alt="">
            <p>التسويق</p>
        </div>
        <div class="col-md-2 col-sm-6">
            <img src="{{ asset('images/icons/infosystem.svg') }}" alt="">
            <p>نظم المعلومات</p>
        </div>
        <div class="col-md-2 col-sm-6">
            <img src="{{ asset('images/icons/apps.svg') }}" alt="">
            <p>تصميم التطبيقات</p>
        </div>
        <div class="col-md-2 col-sm-6">
            <img src="{{ asset('images/icons/webdesign.svg') }}" alt="">
            <p>تصميم مواقع</p>
        </div>
    </div>
...
<div id="about" class="about_us">
    <div class="container h-100 align-items-center" style="padding-top: 90px;">
        <div class="about_image">
            <img src="{{ asset('images/home/vedio-bg.svg') }}">
        </div>
        <div class="row" style="height: 423px;">
            ...
            <div class="col-md-6 align-items-end">
                <img src="https://img.freepik.com/free-photo/creative-background-male-hand-with-phone_99433-522.jpg?size=626&ext=jpg" alt="">
            </div>
        </div>
